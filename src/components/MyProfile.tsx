  ...
  const handleSave = async () => {
    const fetchUser = async () => {
      ...
      const { data, error } = await supabase
        .from('users')
        .update({ first: firstName, last_name: lastName, age: age})
        .eq('id', user?.id)
        .select();
        ...
        <Card>
          <Box sx={{ mb: 1 }}>
            ...
            <Typography level="body-sm">
              Customize how your profile information will appear to the medical centres.
            </Typography>
          </Box>
          <Divider />
          <Stack
          ...
          >
            ...
            <Stack spacing={2} sx={{ flexGrow: 1 }}>
              ...
              <Stack direction="row" spacing={2}>
                ...
                <FormControl>
                  <Input size="sm" type="number" value={age?.toString()} onChange={(e) => setAge(Number(e.target.value))} defaultValue="18" />
                </FormControl>
